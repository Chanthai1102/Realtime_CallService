            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="/admin/size-view" class="menu-link">
                                <div data-i18n="Without navbar">Size</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="/admin/color-view" class="menu-link">
                                <div data-i18n="Without navbar">Color</div>
                            </a>
                        </li>
                    </ul>
                </li>
